        ...
        <div class="right">
            <div class="panel-entity-models-card__header-actions">
                <slot name="header-actions" :entity="entity">
                    <?php if (UserAccessService::isAdmin()): ?>
                    <li v-if="!entity.parActions || entity.parActions.length === 0" class="mc-tag-list__tag panel-entity-models-card__par-missing-badge">
                        <?= i::__('SEM AÇÕES DO PAR') ?>
                    </li>
                    <li v-else class="mc-tag-list__tag panel-entity-models-card__par-defined-badge">
                        <?= i::__('AÇÕES DO PAR DEFINIDAS') ?>
                    </li>
                    <?php endif; ?>
